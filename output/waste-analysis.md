...
|---|---|---|---|---|
| 01 | Commure flags case for manual review | Required NVA | — | No |
| 02 | Clinician receives notification | Required NVA | — | No |
| **03** | Navigate to Commure manual review queue | **Motion** | Transportation | **Yes** |
...
| 06 | Enter modifier code in Commure | Required NVA | — | Redesign |
| **07** | Navigate back to EMR for secondary diagnosis verification | **Motion** | Transportation | **Yes** |
| 08 | Confirm/correct secondary diagnosis in Commure | Value-Added | — | No |
| 09 | Submit charge in Commure | Value-Added | — | No |
...
|---|---|---|---|
| Waiting | Clinician searches externally for modifier code | Commure does not display modifier suggestions in the review screen | Yes — display layer change |
| Motion | 3 system transitions per case | Commure review screen does not surface secondary diagnosis data inline | Yes — display layer change |
...
**1. Absence of inline modifier and diagnosis data in Commure review screen**
