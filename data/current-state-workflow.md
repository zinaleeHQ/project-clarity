...
**Process:** Commure Non-Autonomous Case — Manual Charge Entry
...
|---|---|---|---|---|---|
| **01** | Clinical encounter concludes — Commure flags case as requiring manual review | Commure AI | Commure | 0 min | Required NVA |
| **02** | Clinician receives manual review notification (email or in-app — varies by site) | Hospitalist | Commure / EMR | 0.3 min | Required NVA |
| **03** | Clinician navigates to Commure manual review queue | Hospitalist | Commure | 0.8 min | **NVA — Motion** |
| **04** | Clinician opens flagged case and reviews AI-generated clinical documentation summary | Hospitalist | Commure | 1.2 min | Value-Added |
...
| **06** | Clinician returns to Commure and manually enters the modifier code | Hospitalist | Commure | 0.6 min | Required NVA |
| **07** | Commure prompts for secondary diagnosis confirmation — clinician navigates back to EMR to verify | Hospitalist | EMR | 1.1 min | **NVA — Motion** |
| **08** | Clinician returns to Commure and confirms or corrects secondary diagnosis | Hospitalist | Commure | 0.4 min | Value-Added |
| **09** | Clinician submits charge in Commure | Hospitalist | Commure | 0.3 min | Value-Added |
...
| **11** | Clinician documents the manual review decision in a free-text notes field (no standard format) | Hospitalist | Commure | 0.6 min | Required NVA |
...
|---|---|---|
| Step 05 — Finding the right modifier | External app / call billing / recall from memory | No embedded modifier reference in Commure |
| Step 07 — Secondary diagnosis verification | Full EMR chart / Commure summary / skip entirely | No standardized verification protocol |
...
```
Commure Platform ⇄ Hospital EMR (Epic or Cerner)
        ↓
   Billing System
        ↓
